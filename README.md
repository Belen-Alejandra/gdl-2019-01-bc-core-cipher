...
La interfaz del programa es sencilla e intuitiva, mediante un cuadro de texto se introduce la palabra u oración  en **mayúsculas**, en el caso de que se la accion sea cifrar, se elige un número positivo  que servira como clave y solo se puede descodificar con la clave apropiada.
